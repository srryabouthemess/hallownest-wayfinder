...
namespace HallownestWayfinder
{
    ...
    public static class GuideContinuation
    {
        public static readonly IReadOnlyList<RouteStep> Steps = new List<RouteStep>
        {
            ...
            S("c03_ogres", "Cap. 03 • Derrotar os Cogumelos", "Desça até o fundo do primeiro poço e siga à esquerda. Derrote os dois cogumelos guerreiros para receber um encaixe de amuleto.", null, targetScene: "Fungus2_05", arrow: 270f),
            ...
            S("c03_claw", "Cap. 03 • Obter a Garra de Louva-a-Deus", "Atravesse os cogumelos elásticos até a Vila dos Louva-a-Deus, acione a alavanca inferior e pegue a Garra na área superior.", null, pb: "hasWalljump", arrow: 270f),
            ...
            S("c04_lantern", "Cap. 04 • Comprar a Lanterna", "Viaje a Dirtmouth e compre de Sly a Lanterna de Lumélula por 1800 Geo; depois retorne à Estação da Rainha.", null, pb: "hasLantern", arrow: 90f),
            ...
            S("c04_spore", "Cap. 04 • Pegar Cogumelo com Esporos", "Abaixo da larva, cruze as piscinas de ácido e pegue o amuleto; abra a parede à esquerda para sair.", null, pb: "gotCharm_17", arrow: 180f),
            ...
            S("c04_nail1", "Cap. 04 • Afiar o ferrão", "Na parte baixa da cidade, encontre o Ferreiro à esquerda e compre a primeira melhoria por 250 Geo.", null, optional: true, pi: "nailSmithUpgrades", min: 1, arrow: 270f),
            ...
            S("c04_spell_twister", "Cap. 04 • Pegar Distorcedor de Magias", "No Santuário das Almas, procure a abertura escura no teto antes da arena principal.", null, pb: "gotCharm_33", arrow: 45f),
            S("c04_soul_master", "Cap. 04 • Derrotar Mestre das Almas", "Abra os atalhos do Santuário e avance pela porta esquerda do salão superior. Vencendo, receba Mergulho Desolador.", null, pi: "quakeLevel", min: 1, arrow: 270f),
            ...
            S("c05_salubra", "Cap. 05 • Comprar encaixe com Salubra", "Viaje à Encruzilhada, siga além da antiga arena da Mãe Mosca e compre o primeiro encaixe disponível.", null, arrow: 90f),
            ...
            S("c05_shop_key", "Cap. 05 • Pegar a Chave do Lojista", "Continue subindo pelo lado direito das minas e pegue a chave no topo do poço.", null, pb: "hasSlykey", arrow: 45f),
            S("c05_heart", "Cap. 05 • Obter Coração de Cristal", "Atravesse o grande desafio de lasers no lado direito do Pico e examine o autômato quebrado.", null, pb: "hasSuperDash", arrow: 90f),
            ...
            S("c05_dark", "Cap. 05 • Obter Escuridão Descente", "Atravesse a sala escura até o Monte Cristalizado, liberte o Xamã preso e melhore o mergulho.", null, pi: "quakeLevel", min: 2, arrow: 90f),
            S("c06_dream_nail", "Cap. 06 • Obter o Ferrão dos Sonhos", "Caia do Monte Cristalizado aos Campos de Descanso e complete a sequência do memorial.", null, pb: "hasDreamNail", arrow: 180f),
            S("c06_dreamshield", "Cap. 06 • Pegar Escudo dos Sonhos", "Explore a passagem abaixo da casa da Vidente antes de liberar a estação.", null, pb: "gotCharm_38", arrow: 180f),
            ...
            S("c07_elegant", "Cap. 07 • Comprar a Chave Elegante", "Entregue a Chave do Lojista a Sly, compre a Chave Elegante e adquira o mapa dos Campos com Iselda.", null, arrow: 90f),
            ...
            S("c08_dung", "Cap. 08 • Derrotar Defensor do Esterco", "Siga os túneis marrons após o banco e derrote Ogrim para receber o Brasão do Defensor.", null, pb: "killedDungDefender", arrow: 90f),
            S("c08_isma", "Cap. 08 • Obter Lágrima de Isma", "Use o Coração de Cristal pelo túnel de espinhos, vença a emboscada de guardas e alcance o bosque de Isma.", null, pb: "hasAcidArmour", arrow: 90f),
            ...
            S("c09_ore1", "Cap. 09 • Pegar Minério Pálido da Bacia", "Desça à Bacia Antiga e explore a área dos Mawleks no canto inferior esquerdo.", null, pi: "ore", min: 1, arrow: 225f),
            ...
            S("c09_broken", "Cap. 09 • Derrotar Receptáculo Quebrado", "Atravesse o abismo de espinhos no lado esquerdo e siga até a arena.", null, pb: "killedInfectedKnight", arrow: 270f),
            S("c09_wings", "Cap. 09 • Obter Asas do Monarca", "Após a luta, siga à esquerda e para baixo até a antiga carcaça para receber o pulo duplo.", null, pb: "hasDoubleJump", arrow: 225f),
            S("c09_lost_kin", "Cap. 09 • Derrotar Parente Perdido", "Use o Ferrão dos Sonhos no corpo do Receptáculo Quebrado e vença sua versão onírica.", null, pb: "infectedKnightDreamDefeated", arrow: 90f),
            ...
            S("c10_joni", "Cap. 10 • Pegar Bênção de Joni", "Atravesse a sala escura seguindo as flores azuis até o repouso de Joni.", null, pb: "gotCharm_27", arrow: 90f),
            S("c10_cyclone", "Cap. 10 • Aprender Corte Ciclone", "Suba ao topo dos penhascos e encontre a cabana de Mato na fenda sob a borda.", null, pb: "hasCyclone", arrow: 90f),
            S("c10_gorb", "Cap. 10 • Derrotar Gorb", "Continue ao topo esquerdo e desafie o espírito no monumento.", null, pb: "aladarSlugDefeated", arrow: 315f),
            ...
            S("c11_grimmchild", "Cap. 11 • Receber Grimmchild", "Volte a Dirtmouth, entre na tenda principal e fale com Mestre da Trupe Grimm.", null, pb: "gotCharm_40", arrow: 90f),
            S("c11_failed", "Cap. 11 • Derrotar Campeão Fracassado", "Na Encruzilhada Infectada, quebre a parede acima da antiga arena do Falso Cavaleiro e entre no sonho do corpo.", null, pb: "falseKnightDreamDefeated", arrow: 315f),
            S("c11_xero", "Cap. 11 • Derrotar Xero", "Nos Campos de Descanso, desafie o espírito vermelho sobre a plataforma onde você caiu inicialmente.", null, pb: "xeroDefeated", arrow: 270f),
            S("c11_dreamgate", "Cap. 11 • Desbloquear Portal dos Sonhos", "Entregue essência à Vidente até receber Minério Pálido, Amuleto do Portador e Portal dos Sonhos.", null, pb: "hasDreamGate", arrow: 90f),
            S("c12_deep_focus", "Cap. 12 • Pegar Foco Profundo", "Retorne ao Pico por Dirtmouth e use o Coração de Cristal através dos lasers até a geoda escondida.", null, pb: "gotCharm_34", arrow: 90f),
            S("c12_guardians", "Cap. 12 • Derrotar Guardiões de Cristal", "Vença o Guardião no banco e depois suba pela parede direita para enfrentar sua versão enfurecida.", null, pb: "defeatedMegaBeamMiner2", arrow: 0f),
            S("c12_ore", "Cap. 12 • Pegar Minério Pálido da Coroa", "Suba até a Coroa de Hallownest e pegue o minério aos pés da estátua.", null, pi: "ore", min: 3, arrow: 315f),
            S("c13_sheo", "Cap. 13 • Aprender Grande Corte", "Na parte baixa do Caminho Verde, atravesse Durandas e espinhos até a casa de Sheo.", null, pb: "hasUpwardSlash", arrow: 270f),
