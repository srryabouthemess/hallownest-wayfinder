...
namespace HallownestWayfinder
{
    ...
    public static class SpeedrunRouteDefinition
    {
        ...
        public static readonly IReadOnlyList<RouteStep> Steps = new List<RouteStep>
        {
            ...
            S("sr01_geo", "Seg. 01 • Juntar 50 Geo", "Quebre os depósitos de Geo no caminho até a estação da Encruzilhada. Evite parar para farmar inimigos comuns.", "crawlid.png", pi: "geo", min: 50, arrow: 225f),
            ...
            S("sr02_bench", "Seg. 02 • Usar o banco do Caminho Verde", "Sente no banco da estação, mas não gaste Geo liberando o Último Besouro.", "bench.png", benchScene: "Fungus1_16_alt", target: "Fungus1_16_alt", arrow: 180f),
            ...
            S("sr03_queen_bench", "Seg. 03 • Usar o banco da Estação da Rainha", "Atravesse o Cânion da Névoa e sente no banco da estação antes de entrar nos Ermos Fúngicos.", "bench.png", benchScene: "Fungus2_02", arrow: 180f),
            S("sr03_seal", "Seg. 03 • Pegar o Selo de Hallownest", "Recolha o selo indicado pela rota; ele ajudará a pagar as compras na Cidade das Lágrimas.", "Wanderers_Journal.png", intSum: new[] { "trinket2", "soldTrinket2" }, sumMin: 1, arrow: 90f),
            ...
            S("sr04_seal", "Seg. 04 • Pegar o selo a caminho do Santuário", "Suba pela cidade e recolha o Selo de Hallownest indicado antes de entrar no Santuário das Almas.", "Wanderers_Journal.png", intSum: new[] { "trinket2", "soldTrinket2" }, sumMin: 2, arrow: 0f),
            S("sr04_bench", "Seg. 04 • Comprar o banco do Santuário", "Se faltar Geo, venda uma relíquia a Lemm. Pague o banco e sente antes de enfrentar o Santuário.", "bench.png", pb: "tollBenchCity", arrow: 90f),
            ...
            S("sr04_sell", "Seg. 04 • Vender todas as relíquias a Lemm", "Volte ao banco, equipe Distorcedor de Magias, venda as relíquias e faça save & quit. Proteja esse Geo.", "Wanderers_Journal.png", pb: "metRelicDealer", noRelics: true, arrow: 180f),
            ...
            S("sr07_skip", "Seg. 07 • Fazer o pogo dos Sentinelas", "Tente o pogo no objeto de fundo sob a Torre do Vigia. Se preferir segurança, pegue Asas do Monarca e retorne.", "Monarch_Wings.png", optional: true, visitedScene: "Ruins2_03", arrow: 0f),
            ...
            // Segmento 8 — Monomon
            S("sr08_archives", "Seg. 08 • Chegar aos Arquivos da Professora", "Atravesse o Caminho Verde e o Cânion da Névoa. Use o banco de segurança no topo dos Arquivos.", "Cornifer.png", visitedScene: "Fungus3_archive", arrow: 180f),
            ...
            S("sr08_gardens", "Seg. 08 • Seguir para os Jardins da Rainha", "Use novamente o banco dos Arquivos e siga à esquerda, atravessando o ácido até os Jardins.", "crawlid.png", pb: "visitedRoyalGardens", arrow: 270f),

            // Segmento 9 — Herrah
            S("sr09_bench", "Seg. 09 • Comprar o banco antes do Ninho", "Atravesse os Jardins pela entrada de ácido, pague o banco antes do Ninho Profundo e sente.", "bench.png", pb: "tollBenchQueensGardens", arrow: 270f),
            ...
            string[] intSum = null, int sumMin = 0, bool noRelics = false)
        {
            return new RouteStep
            {
                ...
                RequiredVisitedScene = visitedScene,
                RequiredBenchScene = benchScene,
                RequiredPlayerIntSum = intSum,
                RequiredPlayerIntSumMinimum = sumMin,
                RequireNoRelics = noRelics,
                RequiredScene = scene,
                TargetScene = target,
                ArrowDegrees = arrow
            };
