...
namespace HallownestWayfinder
{
    public static class RouteDefinition
    {
        ...
        public static readonly IReadOnlyList<RouteStep> Steps = new List<RouteStep>
        {
            ...
            Step("grub_1", "Salvar a primeira larva", "Da sala de Cornifer, saia pela esquerda. Continue para a esquerda e procure a jarra de vidro da larva; quebre-a com o ferrão.", "grub.png", 270f, grubScene: "Crossroads_35"),
            ...
            Step("grub_2", "Salvar a segunda larva", "Saia da estação pela direita. Na sala seguinte, suba e ataque a parede falsa do lado esquerdo para alcançar a larva.", "grub.png", 0f, grubScene: "Crossroads_03"),
            Step("grub_3", "Salvar a terceira larva", "Saia da entrada do Pico de Cristal pela esquerda. Suba pela sala vertical e pegue a saída da direita; siga até encontrar a larva.", "grub.png", 45f, grubScene: "Crossroads_48"),
            Step("grub_4", "Salvar a quarta larva", "Retorne à sala ao lado da parede falsa da segunda larva. Entre pela passagem oposta, avance para a direita e depois desça até a larva.", "grub.png", 135f, grubScene: "Crossroads_31"),
            ...
            Step("grub_5", "Salvar a quinta larva", "Continue pelo Caminho Verde até ver Hornet pela primeira vez. Na área seguinte, procure uma passagem secreta e quebre o cipó que bloqueia o caminho; depois desça e siga pela direita até a larva.", "grub.png", 135f, grubScene: "Fungus1_06"),
            ...
            Step("grub_6", "Salvar a sexta larva", "Saia da cabana do Caçador, volte para a esquerda e desça. Explore a parte inferior até alcançar a jarra da larva.", "grub.png", 225f, grubScene: "Fungus1_07"),
            ...
            Step("grub_7", "Salvar a sétima larva", "Continue pela parte superior do Caminho Verde. Derrote o Cavaleiro do Musgo que guarda a jarra e quebre-a para libertar a larva.", "grub.png", 90f, grubScene: "Fungus1_21"),
